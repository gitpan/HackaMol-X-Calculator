...
$mol->push_atoms( HackaMol::Atom->new(Z=>8, coords=>[V( 0.000000, 0.117958,0.000000)]) );
$mol->push_atoms( HackaMol::Atom->new(Z=>1, coords=>[V( 0.761499,-0.471830,0.000000)]) );
$mol->push_atoms( HackaMol::Atom->new(Z=>1, coords=>[V(-0.761499,-0.471830,0.000000)]) );
